...
@Aspect // AOP 모듈을 정의하는 Annotation
        // 특정 기능의 전/후/예외발생시 동작해야할 공통 로직을 개발할 때 유용
@Component // Spring Bean으로 정의하는 Annotation
		   // @Controller, @Service, @Repository의 부모 Annotation
 		   // Spring Bena으로 등록하려는 클래스가
...
public class TimingAspect {
	...
	public Object timingAdvice(ProceedingJoinPoint pjp) throws Throwable {
		...
		try {
			...
			logger.debug("{}.{} 걸린시간: {}밀리초", classPath, methodName, 
